...
@section('main')
  ...
  <ul>
    ...
    <li><strong>Class B:</strong> These planets will be permitted a planetside force, planetary and orbital weapons, but no spacefleet.</li>
    <li><strong>Class C:</strong> These planets will be able to field planetside forces as well planetary guns and shields, but no spacecraft.</li>
